...
-- local left = [[    TgDatepickerGlobalModule,
--     // Bespoke: Add page to navbar #18370
--     NavbarPagesModule,
-- ]]
-- local middle = [[    TgDatepickerGlobalModule,
-- ]]
-- local right = [[    KeywordSearchGlobalModule,
-- ]]

-- no ij
-- shouldn't merge: yours and your countries are changing the same text in both
-- local left = [[interestsMatchYours: People whose countries match yours
-- withSimilarInterests: People with similar countries
-- withMatchingSkills: People whose cities match your countries
-- ]]
-- local middle = [[interestsMatchYours: People whose interests match yours
-- withSimilarInterests: People with similar interests
-- withMatchingSkills: People whose skills match your interests
-- ]]
-- local right = [[interestsMatchYours: People whose interests match yours
-- withSimilarInterests: People with similar interests
-- withMatchingSkills: People whose skills match yours
-- ]]

-- local left = [[  showAudiences: false,
--   // If admin can see the membership in the guest list
--   showMembership: true,
-- ]]
-- local middle = [[  showAudiences: true,
--   // If admin can see the membership in the guest list
--   showMembership: true,
-- ]]
-- local right = [[  showAudiences: true,
--   // If admins can see events in the guest list
--   showEvents: true,
-- ]]
...
-- local left = [[import type {App, HooksConfig, Request, Response} from '../../../definitions/sails';
-- ]]
-- local middle = [[import type {App, HooksConfig, Request, Response} from '../../../definitions/sails';
-- import {HttpStatusCode} from '../../util/HttpStatusCode';
-- ]]
-- local right = [[import type {App, HooksConfig} from '../../../definitions/sails';
-- ]]

-- no ij
-- actually broken: import {Directive,Directive, ElementRef,ElementRef, inject,Injector, Input,Input, Renderer2}Renderer2} from '@angular/core'@angular/core';
-- Injector and inject are added to the exact same place
-- local left = [[import {Directive, ElementRef, Injector, Input, Renderer2} from '@angular/core';
-- ]]
-- local middle = [[import {ChangeDetectionStrategy, Component, forwardRef, Input} from '@angular/core';
-- import {NG_VALUE_ACCESSOR} from '@angular/forms';
-- ]]
-- local right = [[import {Directive, ElementRef, inject, Input, Renderer2} from '@angular/core';
-- ]]

-- no ij
-- just adds every line semi twice: super();super(inj); this.r2 = inject(Render2); inj.get(Renderer2);
-- local left = [[  public constructor(inj: Injector) {
--     super(inj);
...
-- ]]
-- local middle = [[]]
-- local right = [[  public constructor() {
--     super();
...
-- local left = [[import type {OnChanges, OnInit, SimpleChanges} from '@angular/core';
-- import {ChangeDetectionStrategy, Component, Input} from '@angular/core';
-- import ElementRenderingService from '../../layout/element-rendering.service';
-- import {TranslateModule} from '../../translate/translate.module';
-- import type {BsStyle} from '../../util/bs-style';
--
...
--   providers: [ElementRenderingService],
--   selector: 'tg-elastic-label',
--   standalone: true,
--   styles: [':host{font-size:14px;display:inline}'],
--   template: '{{label.txt|tr:\'keywordSearch\'}}',
-- })
-- export class ElasticLabelComponent implements OnChanges, OnInit {
--   @Input()
--   public label: ElasticLabel;
--
--   public constructor(private readonly rend: ElementRenderingService) {}
--
--   /** @inheritDoc */
...
--     }
--
--     const prev: ElasticLabel | undefined = label.previousValue;
--     if (prev) {
--       this.rend.r2.removeClass(this.rend.el, `label-${prev.style}`);
--     }
--
--     this.rend.addClasses(`label-${this.label.style}`);
--   }
--
--   /** @inheritDoc */
--   public ngOnInit(): void {
--     this.rend.addClasses('label');
--   }
-- }
-- ]]
-- local middle = [[]]
-- local right = [[import type {OnChanges, OnInit, SimpleChanges} from '@angular/core';
-- import {ChangeDetectionStrategy, Component, Input} from '@angular/core';
-- import ElementRenderingService from '../../layout/element-rendering.service';
-- import type {BsStyle} from '../../util/bs-style';
--
