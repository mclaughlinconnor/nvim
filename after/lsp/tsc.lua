return {
  cmd = function(dispatchers, config)
    return vim.lsp.rpc.start({ "node", "/Users/connorveryconnect.com/.local/share/nvim/mason/packages/tsc/node_modules/typescript/lib/tsc.js", '--lsp', '--stdio' }, dispatchers)
  end,
